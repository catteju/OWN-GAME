...
function preload(){
  ...
  maskImg = loadImage("Images/download.png");
  OBImg = loadImage("Images/images.jpg");
  corona1Img = loadImage("Images/Corona 1.png");
  corona2Img = loadImage("Images/Corona 1.png");
  corona3Img = loadImage("Images/Corona 1.png");
  corona4Img = loadImage("Images/Corona 1.png");
  letter = loadImage("Images/Wood.PNG");
  letter2 = loadImage("Images/Wood 2.PNG");
  letter3 = loadImage("Images/Wood 3.PNG");
